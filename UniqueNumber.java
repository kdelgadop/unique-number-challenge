...
//The number ammount of unique numbers and number of digits are SET along with maximun and minimun numbers in such age range.
    public void unRandNum(int numAmmount, int numOfDigits) {
            if(numOfDigits==1) {
                if(numAmmount>10) {
                    this.numAmmount=10;
                    System.out.println("We're sorry for the inconvenience but lists of numbers with " + numOfDigits + " digits have a maximun capacity of " + numAmmount + " elements.");
                }
                    else {
...
public void numbersGenerators() {
    System.out.println( "the numbers are: " + this.maxNum + " " + this.minNum + " " + this.numAmmount + " " + this.numOfDigits);
    int[] uniqueRandNum = new int[numAmmount];
        ...
        //this method is to iterate trough the array and make sure that each element is different from the other.
                                ...
                                if(uniqueRandNum[j] == uniqueRandNum[l]) {
                                    ...
                                    for (int k=0; k < uniqueRandNum.length; k++) {
                                        if(j==k) {  
                                            ...
                                            k=-1;
                                            //This commented line bellow is there in case you wish to see the array change digit by digit as each number becomes unique.
